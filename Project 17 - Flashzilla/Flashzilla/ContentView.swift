...
struct ContentView: View {
            ...
            VStack {
                ...
                ZStack {
                    ForEach(Array(cards.enumerated()), id: \.element) { item in
                        CardView(card: item.element) { reinstated in
                            withAnimation {
                                removeCard(at: item.offset, reinstated: reinstated)
                            }
                        }
            ...
            if differentiateWithoutColor || voiceOverEnabled {
                VStack {
                    ...
                    HStack {
                        Button {
                            withAnimation {
                                removeCard(at: cards.count - 1, reinstated: true)
                            }
                        } label: {
                        ...
                        Button {
                            withAnimation {
                                removeCard(at: cards.count - 1, reinstated: false)
                            }
                        } label: {
    ...
    func removeCard(at index: Int, reinstated: Bool) {
